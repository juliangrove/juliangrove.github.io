...
//       $(".display_condition").html("Fact:" + stim.fact);
//     },
//     button : function() {
...
function init() {
  exp.trials = [];
  exp.catch_trials = [];
  exp.all_stims = _.shuffle(_.shuffle([list3])[0]); //can randomize between subject conditions here
...
exp.structure=["i0", "one_slider", 'subj_info', 'thanks'];
