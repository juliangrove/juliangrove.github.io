...
//       }
	var utterance = "You are at a party. You walk into the kitchen and overhear " + this.stim.name + " ask somebody else a question. " + this.stim.name + " doesn't know you and wants to be secretive, so speaks in somewhat coded language.";
