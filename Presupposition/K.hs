...
-- | A datatype constructor 'PContT' for transforming a graded monad into its
-- continuized variant as a parameterized monad.
...
-- | The parameterized monad operator 'downK' is just @ap@.
