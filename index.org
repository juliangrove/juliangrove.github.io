...
* About
  ...
  Getting this to happen means that accounts of human behavior---for example, in formal linguistics experiments---can be integrated with traditional Montagovian approaches to semantics fairly seamlessly.
